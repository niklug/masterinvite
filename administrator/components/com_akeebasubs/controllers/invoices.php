...
class AkeebasubsControllerInvoices extends FOFController
{
	public function download($cachable = false, $urlparams = false)
	{
                ...
                if($type == 'creditnota') {
                    ...
                    $path = JPATH_ADMINISTRATOR . '/components/com_akeebasubs/' . $record_table . '/';
                    ...
                    {
                            $filename = $model->createPDF($record_table);
                            if ($filename == false)
                            {
                                    return false;
                            }
                ...
                if ($type == 'creditnota')
		{
                    ...
                    $basename = 'creditnota' . $id;
		}
		elseif (empty($item->display_number))
		{
