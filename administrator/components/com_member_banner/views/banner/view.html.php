 ...
 * View to edit
 */
class Member_bannerViewBanner extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$canDo		= Member_bannerHelper::getActions();

		JToolBarHelper::title(JText::_('COM_MEMBER_BANNER_TITLE_BANNER'), 'banner.png');
